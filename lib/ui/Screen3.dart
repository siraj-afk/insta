...
class _Screen1State extends State<Screen3> {
  ...
  @override
  void initState() {
    BlocProvider.of<InstaBloc>(context).add(fetchInstaEvent(id: widget.username));
    BlocProvider.of<HighlightsBloc>(context).add(fetchHighlightsEvent(id: widget.username));
    BlocProvider.of<PostBloc>(context).add(fetchPostEvent(id: widget.username));
    BlocProvider.of<TagBloc>(context).add(fetchTagEvent(id: widget.username));
    super.initState();
  }
              ...
              return RefreshIndicator(
                  ...
                  onRefresh: () async {
                    return BlocProvider.of<InstaBloc>(context)
                        .add(fetchInstaEvent(id: widget.username));
                  });
            }
                                      ...
                                      return RefreshIndicator(
                                          ...
                                          onRefresh: () async {
                                            return BlocProvider.of<HighlightsBloc>(
                                                context)
                                                .add(fetchHighlightsEvent(id: widget.username));
                                          });
                                    }
                            ...
                            return RefreshIndicator(
                                ...
                                onRefresh: () async {
                                  return BlocProvider.of<PostBloc>(context)
                                      .add(fetchPostEvent(id: widget.username));
                                });
                          }
                            ...
                            return RefreshIndicator(
                                ...
                                onRefresh: () async {
                                  return BlocProvider.of<TagBloc>(context)
                                      .add(fetchTagEvent(id: widget.username));
                                });
                          }
