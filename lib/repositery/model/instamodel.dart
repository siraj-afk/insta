...
class Data {
  ...
  Data({this.about, this.accountBadges, this.accountType, this.activeStandaloneFundraisers, this.adjustedBannersOrder, this.adsIncentiveExpirationDate, this.adsPageId, this.adsPageName, this.bioLinks, this.biography, this.biographyEmail, this.biographyWithEntities, this.businessContactMethod, this.canAddFbGroupLinkOnProfile, this.canHideCategory, this.canHidePublicContacts, this.category, this.categoryId, this.contactPhoneNumber, this.currentCatalogId, this.directMessaging, this.externalLynxUrl, this.externalUrl, this.fbidV2, this.followerCount, this.followingCount, this.fullName, this.hasAnonymousProfilePicture, this.hasChaining, this.hasGenAiPersonasForProfileBanner, this.hasGuides, this.hasIgtvSeries, this.hdProfilePicUrlInfo, this.hdProfilePicVersions, this.id, this.isBusiness, this.isCallToActionEnabled, this.isCategoryTappable, this.isEligibleForRequestMessage, this.isFavorite, this.isFavoriteForClips, this.isFavoriteForIgtv, this.isFavoriteForStories, this.isOpenToCollab, this.isParentingAccount, this.isPrivate, this.isProfileAudioCallEnabled, this.isVerified, this.latestReelMedia, this.liveSubscriptionStatus, this.locationData, this.mediaCount, this.pageId, this.pageName, this.pinnedChannelsInfo, this.primaryProfileLinkType, this.professionalConversionSuggestedAccountType, this.profileContext, this.profileContextFacepileUsers, this.profileContextLinksWithUserIds, this.profilePicId, this.profilePicUrl, this.profilePicUrlHd, this.publicEmail, this.publicPhoneCountryCode, this.publicPhoneNumber, this.thirdPartyDownloadsEnabled, this.totalIgtvVideos, this.upcomingEvents, this.username});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if(json["ads_page_id"] is num) {
      adsPageId = (json["ads_page_id"] as num).toInt();
    }
    if(json["ads_page_name"] is String) {
    ...
    if(json["has_gen_ai_personas_for_profile_banner"] is bool) {
      hasGenAiPersonasForProfileBanner = json["has_gen_ai_personas_for_profile_banner"];
    }
    ...
    if(json["page_id"] is num) {
      pageId = (json["page_id"] as num).toInt();
    }
    if(json["page_name"] is String) {
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["has_gen_ai_personas_for_profile_banner"] = hasGenAiPersonasForProfileBanner;
  ...
  Data copyWith({
    ...
    hasGenAiPersonasForProfileBanner: hasGenAiPersonasForProfileBanner ?? this.hasGenAiPersonasForProfileBanner,
...
class BioLinks {
  ...
  BioLinks({this.iconUrl, this.imageUrl, this.isPinned, this.isVerified, this.linkId, this.linkType, this.lynxUrl, this.openExternalUrlWithInAppBrowser, this.title, this.url});
