...
class Items {
  ...
  Items.fromJson(Map<String, dynamic> json) {
    ...
    if(json["carousel_media"] is List) {
      carouselMedia = json["carousel_media"] == null ? null : (json["carousel_media"] as List).map((e) => CarouselMedia.fromJson(e)).toList();
    }
    ...
    if(json["carousel_media_ids"] is List) {
      carouselMediaIds = json["carousel_media_ids"] == null ? null : List<int>.from(json["carousel_media_ids"]);
    }
    if(json["carousel_media_pending_post_count"] is num) {
      carouselMediaPendingPostCount = (json["carousel_media_pending_post_count"] as num).toInt();
    }
    ...
    if(json["image_versions"] is Map) {
      imageVersions = json["image_versions"] == null ? null : ImageVersions1.fromJson(json["image_versions"]);
    }
    ...
    if(json["media_notes"] is Map) {
      mediaNotes = json["media_notes"] == null ? null : MediaNotes.fromJson(json["media_notes"]);
    }
    ...
    if(json["timeline_pinned_user_ids"] is List) {
      timelinePinnedUserIds = json["timeline_pinned_user_ids"] == null ? null : List<int>.from(json["timeline_pinned_user_ids"]);
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["coauthor_producer_can_see_organic_insights"] = coauthorProducerCanSeeOrganicInsights;
  ...
  Items copyWith({
    ...
    boostUnavailableReasonV2: boostUnavailableReasonV2 ?? this.boostUnavailableReasonV2,
    ...
    carouselMediaPendingPostCount: carouselMediaPendingPostCount ?? this.carouselMediaPendingPostCount,
    clipsTabPinnedUserIds: clipsTabPinnedUserIds ?? this.clipsTabPinnedUserIds,
    coauthorProducerCanSeeOrganicInsights: coauthorProducerCanSeeOrganicInsights ?? this.coauthorProducerCanSeeOrganicInsights,
    ...
    hasHighRiskGenAiInformTreatment: hasHighRiskGenAiInformTreatment ?? this.hasHighRiskGenAiInformTreatment,
    ...
    isEligibleForMetaAiShare: isEligibleForMetaAiShare ?? this.isEligibleForMetaAiShare,
    ...
    metaAiSuggestedPrompts: metaAiSuggestedPrompts ?? this.metaAiSuggestedPrompts,
    musicMetadata: musicMetadata ?? this.musicMetadata,
    openCarouselShowFollowButton: openCarouselShowFollowButton ?? this.openCarouselShowFollowButton,
    openCarouselSubmissionState: openCarouselSubmissionState ?? this.openCarouselSubmissionState,
    ...
    profileGridThumbnailFittingStyle: profileGridThumbnailFittingStyle ?? this.profileGridThumbnailFittingStyle,
    ...
    timelinePinnedUserIds: timelinePinnedUserIds ?? this.timelinePinnedUserIds,
...
class FanClubInfo1 {
  ...
  FanClubInfo1({this.autosaveToExclusiveHighlight, this.connectedMemberCount, this.fanClubId, this.fanClubName, this.fanConsiderationPageRevampEligiblity, this.hasCreatedSsc, this.hasEnoughSubscribersForSsc, this.isFanClubGiftingEligible, this.isFanClubReferralEligible, this.isFreeTrialEligible, this.largestPublicBcId, this.subscriberCount});
...
class SharingFrictionInfo1 {
  ...
  SharingFrictionInfo1({this.bloksAppUrl, this.sharingFrictionPayload, this.shouldHaveSharingFriction});
...
class FanClubInfo {
  ...
  FanClubInfo({this.autosaveToExclusiveHighlight, this.connectedMemberCount, this.fanClubId, this.fanClubName, this.fanConsiderationPageRevampEligiblity, this.hasCreatedSsc, this.hasEnoughSubscribersForSsc, this.isFanClubGiftingEligible, this.isFanClubReferralEligible, this.isFreeTrialEligible, this.largestPublicBcId, this.subscriberCount});
